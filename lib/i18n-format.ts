/** Missatges i helpers i18n (sense components React). */
...
const translations: Record<Locale, Record<string, string>> = {
  ...
  es: {
    ...
    'products.switchToGridView': 'Cambiar a vista de cuadrícula',
    'products.switchToListView': 'Cambiar a vista de lista',
    ...
    'config.gdpr.title': 'Protección de datos (RGPD)',
    'config.gdpr.exportDescription': 'Descarga una copia de todos tus datos personales en formato JSON.',
    'config.gdpr.deleteDescription': 'Elimina permanentemente tu cuenta y todos tus datos. Esta acción no se puede deshacer.',
    'legal.privacy.title': 'Política de Privacidad',
    'legal.privacy.lastUpdated': 'Última actualización',
    'legal.privacy.section1.title': '1. Introducción',
    'legal.privacy.section1.content': 'Esta Política de Privacidad describe cómo recopilamos, utilizamos y protegemos tu información personal cuando usas la plataforma Xarxa Anglesola. Nos comprometemos a proteger tu privacidad y a cumplir con la normativa de protección de datos aplicable.',
    'legal.privacy.section2.title': '2. Datos que recopilamos',
    'legal.privacy.section2.item1': 'Datos de identificación: nickname, email, nombre (opcional)',
    'legal.privacy.section2.item2': 'Datos de autenticación: contraseña cifrada, tokens de sesión',
    'legal.privacy.section2.item3': 'Contenido generado: productos publicados, mensajes de chat, lista de favoritos',
    'legal.privacy.section2.item4': 'Datos de comportamiento: preferencias de notificación, actividad en la plataforma',
    'legal.privacy.section2.item5': 'Datos técnicos: dirección IP, cookies, información del dispositivo',
    'legal.privacy.section3.title': '3. Finalidad del tratamiento',
    'legal.privacy.section3.content': 'Utilizamos tus datos para: prestar y mejorar nuestros servicios, gestionar tu cuenta, facilitar la comunicación entre usuarios, enviar notificaciones relevantes, garantizar la seguridad de la plataforma y cumplir con obligaciones legales.',
    'legal.privacy.section4.title': '4. Base legal',
    'legal.privacy.section4.content': 'El tratamiento de tus datos se basa en: tu consentimiento, la ejecución de un contrato (prestación del servicio), el interés legítimo (seguridad y mejora del servicio) y el cumplimiento de obligaciones legales.',
    'legal.privacy.section5.title': '5. Tus derechos',
    'legal.privacy.section5.content': 'De acuerdo con el Reglamento General de Protección de Datos (RGPD), tienes derecho a:',
    'legal.privacy.section5.right1': 'Acceso: obtener una copia de tus datos personales',
    'legal.privacy.section5.right2': 'Rectificación: corregir datos inexactos o incompletos',
    'legal.privacy.section5.right3': 'Supresión: solicitar la eliminación de tus datos',
    'legal.privacy.section5.right4': 'Portabilidad: recibir tus datos en un formato estructurado',
    'legal.privacy.section5.right5': 'Oposición: oponerte al tratamiento de tus datos en determinadas circunstancias',
    'legal.privacy.section6.title': '6. Conservación de datos',
    'legal.privacy.section6.content': 'Conservamos tus datos mientras tu cuenta esté activa y durante el periodo necesario para cumplir con obligaciones legales. Puedes eliminar tu cuenta en cualquier momento desde la configuración.',
    'legal.privacy.section7.title': '7. Seguridad',
    'legal.privacy.section7.content': 'Implementamos medidas de seguridad técnicas y organizativas para proteger tus datos contra el acceso no autorizado, la pérdida o la destrucción. Las contraseñas se almacenan cifradas y utilizamos conexiones seguras (HTTPS).',
    'legal.privacy.section8.title': '8. Contacto',
    'legal.privacy.section8.content': 'Para ejercer tus derechos o consultar sobre privacidad, puedes contactarnos a través de la configuración de tu cuenta o utilizando las funciones de gestión de datos disponibles en la plataforma.',
    ...
    'legal.terms.section1.content': 'Al usar la plataforma Xarxa Anglesola, aceptas estos Términos y Condiciones. Si no estás de acuerdo, no uses el servicio.',
    'legal.terms.section2.title': '2. Uso del servicio',
    'legal.terms.section2.content': 'Te comprometes a usar la plataforma de forma lícita y respetuosa. No puedes usar el servicio para actividades ilegales, fraudulentas o que vulneren derechos de terceros.',
    'legal.terms.section3.title': '3. Contenido del usuario',
    'legal.terms.section3.content': 'Eres responsable del contenido que publicas (productos, mensajes, imágenes). Nos reservamos el derecho de moderar y eliminar contenido que consideremos inadecuado, ofensivo o que vulnere estos términos.',
    'legal.terms.section4.title': '4. Propiedad intelectual',
    'legal.terms.section4.content': 'Los usuarios conservan los derechos sobre el contenido que publican. Al publicar contenido, nos otorgas una licencia para usarlo dentro de la plataforma para la prestación del servicio.',
    'legal.terms.section5.title': '5. Limitación de responsabilidad',
    'legal.terms.section5.content': 'La plataforma se proporciona «tal cual». No nos responsabilizamos de daños directos, indirectos o consecuentes derivados del uso del servicio. Los intercambios entre usuarios son responsabilidad de los usuarios.',
    'legal.terms.section6.title': '6. Modificaciones',
    'legal.terms.section6.content': 'Nos reservamos el derecho de modificar estos términos en cualquier momento. Las modificaciones entrarán en vigor cuando se publiquen en la plataforma. El uso continuado del servicio después de las modificaciones implica la aceptación de los nuevos términos.',
    'legal.terms.section7.title': '7. Resolución de conflictos',
    'legal.terms.section7.content': 'Cualquier disputa relacionada con el uso de la plataforma se regirá por la legislación española y catalana. Los usuarios se comprometen a intentar resolver los conflictos de forma amistosa antes de recurrir a acciones legales.',
    'legal.cookies.message': 'Este sitio web utiliza cookies para mejorar la experiencia de usuario y proporcionar funcionalidades esenciales.',
    'legal.cookies.learnMore': 'Más información',
    'legal.cookies.accept': 'Aceptar',
    'legal.cookies.reject': 'Rechazar',
    'legal.gdpr.exportData': 'Exportar datos',
    'legal.gdpr.deleteAccount': 'Eliminar cuenta',
    'legal.gdpr.exportSuccess': 'Tus datos se han exportado correctamente',
    'legal.gdpr.exportError': 'Error al exportar los datos',
    'legal.gdpr.deleteConfirm': '¿Seguro que quieres eliminar tu cuenta? Esta acción no se puede deshacer.',
    'legal.gdpr.deleteSuccess': 'Tu cuenta se ha eliminado correctamente',
    'legal.gdpr.deleteError': 'Error al eliminar la cuenta',
  },
  en: {
    'common.appName': 'Xarxa Anglesola',
...
export function listTranslationKeys(locale: Locale): string[] {
