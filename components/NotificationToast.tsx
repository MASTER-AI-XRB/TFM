...
function notificationTypeToIcon(nt?: string, ownerReserve?: boolean) {
  if (!nt) return null
...
export default function NotificationToast({ notification, onClose }: NotificationToastProps) {
  ...
  const typeIcon = notificationTypeToIcon(notification.notificationType, notification.ownerReserve)

  return (
    <div className="max-w-sm w-full animate-slide-in-right pointer-events-auto">
      <div
        className={`${TYPE_STYLES[notification.type]} text-white rounded-lg shadow-lg p-4 flex items-start gap-3 cursor-default`}
      >
